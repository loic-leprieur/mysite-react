          ...
          <div className="col s12 m6 l4">
            <div className="card">
              ...
              <div className="card-action">
                ...
                <p>
                  Application utilisant une base de données locale pour stocker des tâches à
                  accomplir dans une liste modifiable. Implémentation de CRUD et de contrôles UI sur
            ...
            <div className="card">
              ...
              <div className="card-action">
                ...
                <p>
                  ...
                  niveaux. Le principe repose sur les jeux des années 80's où l'on saisissait du
                  texte pour exécuter des actions et dont la problématique reposait sur les
                  commandes comprises par l'ordinateur et l'enchaînement des puzzles avec les objets
                  et les éléments du décor. Application réalisée avec Java FX en version 8.
                </p>
              </div>
            </div>
          </div>
          <div className="col s12 m6 l4">
            <div className="card">
              ...
              <div className="card-action">
                ...
                <p>
                  Application web Angular pour gérer des événements comme des salons. Réalisé avec
                  la méthodologie SCRUM au sein d'une équipe de 3 autres étudiants flammands à
                  Courtrai (Belgique) pour la start-up <strong>Book'u</strong> afin de tester la
                  technologie. (Une application mobile avec Ionic avait aussi été réalisé en
                  parallèle)
                </p>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="card-action">
                ...
                <p>
                  ...
                  d'un stage à O-I Manufacturing (verrerie à Gironcourt-sur-Vraine) j'ai réalisé un
                  site web sur l'intranet de l'entreprise en ASP.NET MVC 5 gérant la base
                  documentaire. Il était possible de récupérer les documents du serveur Windows et
                  les afficher sur le site dans un tableau triable, filtrable et avec une barre de
                  recherche, la base de données sous SQL Server a permis de catégoriser les
                  documents à partir de leur nom.
                </p>
              </div>
            </div>
          </div>
