...
function setCalloutError() {
    ...
    $('#alert-message').html('<strong>ERREUR : </strong>Une erreur est survenue lors de l\'envoi de votre message');
}
            ...
            <div className="parallax-container">
                <div className="main container">
                     ...
                     <div id="alert-message" className="callout not-displayed">
                        {status === 'success' ? (
                            setCalloutSuccess.bind(this)
                        ) : (
                            setCalloutError.bind(this)
                        )}
                    </div>
                    <div className="row">
                        <form method="post"onSubmit={e => handleSubmit(e)} id="contact-form" action="http://localhost:8000/contact" name="contact-form">
                            <div className="input-field">
                                ...
                                <br/>
                                <ReCaptcha sitekey="6LeCU9keAAAAAKv6LbiviEfv9t2IsHsOMbhmnzov" verifyCallback={response => setResponse(response)} />
                                <br/>

                                
                                <input id="btnSubmit" className="orange-background waves-effect waves-light btn" type="submit" value="Envoyer"/>
