        ...
        <section id="accueil" className="section">
            <div className="parallax-container row valign-wrapper">
                <div className="container-profile container center-align valign-wrapper">
                    ...
                    <div id="profile-body" className="col s12 m12 l8 center-align white-text lignten-3-text">
                        <h1 id="title-job">Loïc {nbYearsSinceBirthday()} ans, Analyste&nbsp;développeur
                        ...
                        <a href="mailto:contact@loic-leprieur.fr?subject=Site web (Accueil)" className="white-text valign-wrapper">
                            <i className="medium material-icons">mail_outline</i>&nbsp;<span className="center-align">Email</span>
                        </a>
                        </div>
                    </div>
