            ...
            <div class="card large white darken-4 z-depth-2">
                ...
                <div class="card-content">
                    <div class="headline">
                        ...
                        <h4 class="center-align card-location">Bischheim</h4>
                        <h5 class="center-align card-employment-period">Janvier 2022</h5>
                    </div>
            ...
            <div class="card large white darken-4 z-depth-2">
                ...
                <div class="card-content">
                    <div class="headline">
                        ...
                        <h4 class="center-align card-location">Strasbourg</h4>
                        <h5 class="center-align card-employment-period">CDI de juillet 2021 à novembre 2021</h5>
                    </div>
            ...
            <div class="card large white darken-4 z-depth-2">
                ...
                <div class="card-content">
                    <div class="headline">
                        ...
                        <h4 class="center-align card-location">Chaumont</h4>
                        <h5 class="center-align card-employment-period">CDI de janvier 2020 à mars 2021</h5>
                    </div>
            ...
            <div class="card large white darken-4 z-depth-2">
                ...
                <div class="card-content">
                    <div class="headline">
                        ...
                        <h4 class="center-align card-location">Leudelange, Luxembourg</h4>
                        <h5 class="center-align card-employment-period">CDI en 2017</h5>
                    </div>
            ...
            <div class="card large white darken-4 z-depth-2">
                ...
                <div class="card-content">
                    <div class="headline">
                        ...
                        <h4 class="center-align card-location">Kortrijk, Belgique</h4>
                        <h5 class="center-align card-employment-period">Stage en 2017</h5>
                    </div>
                    <div class="divider"></div>
                    <p class="job-description">
            ...
            <div class="card large white darken-4 z-depth-2">
                ...
                <div class="card-content">
                    <div class="headline">
                        ...
                        <h4 class="center-align card-location">Gironcourt-sur-Vraine</h4>
                        <h5 class="center-align card-employment-period">Stage en 2016</h5>
                    </div>
                    <div class="divider"></div>
                    <p class="job-description">
